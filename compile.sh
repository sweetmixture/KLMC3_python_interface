...
cc -std=c11 -O3 -o CallClassMethod2.x CallClassMethod2.c   -I /work/e05/e05/wkjee/miniconda3/include/python3.11/ -L /work/e05/e05/wkjee/miniconda3/lib/ -lpython3.11
